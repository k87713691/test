		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form method="POST" id="form" class="login100-form validate-form">
					<span class="login100-form-title p-b-49">商家编码</span>

					<div class="wrap-input100 validate-input" data-validate="请输入商家编码">
						<span class="label-input100"></span>

						<input class="input100" type="password" id="xxx" name="pagepwd" placeholder="请输入商家编码">
						<span class="focus-input100" data-symbol=""></span>
					</div>

					<div class="text-right p-t-8 p-b-10">

<a href="javascript:;" onclick="showInfo()"></a>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<?php if($postpwd): ?>
							<script>setTimeout(function() {document.getElementById(layer.tips('警告：密码错误！请访问xxx获取密码！','#fancypig', {tips: [1, '#ec4848'],time: 9000}))}, 30);</script>
							<?php endif; ?>
                            </form>
						</div>
					</div>
...
<script type="text/javascript">
        ...
        ,content: '<div style="padding: 20px; line-height: 22px; background-color: #495057; color: #fff; font-weight: 300;"><br><br>你可以在此添加任何HTML代码<br><br><br><br><img src="qr-code.png" style="width:100%"</img></div>'
