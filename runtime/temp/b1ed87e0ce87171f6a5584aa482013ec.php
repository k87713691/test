<?php /*a:3:{s:66:"/www/wwwroot/sald982.club/application/index/view/user/pwd_pay.html";i:1664903758;s:67:"/www/wwwroot/sald982.club/application/index/view/public/header.html";i:1737689979;s:67:"/www/wwwroot/sald982.club/application/index/view/public/footer.html";i:1732714105;}*/ ?>
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta content="width=device-width,initial-scale=1.0,maximum-scale=1.0,user-scalable=no" name="viewport"><meta content="yes" name="apple-mobile-web-app-capable"><meta content="black" name="apple-mobile-web-app-status-bar-style"><meta content="telephone=no" name="format-detection"><meta content="email=no" name="format-detection"><title>设置密码</title><style type="text/css">
        html {
            font-size: 35px;
        }
...
</style><div id="app"><div class="box"><div class="jun-content"><div class="f_box_addbank"><div class="t_header"><span><img src="/static/wap/images/icon_back.png" alt="" onClick="javascript:history.back()"></span><span><i>修改取款密码</i></span></div><div class="f_content"><ul><li><label>原取款密码</label><span><input type="password" name="oldpwd" id="oldpwd" value="" placeholder="输入原取款密码" onfocus="this.placeholder=''" onblur="this.placeholder='输入原支付密码'"></span></li><li><label>新取款密码</label><span><input type="password" name="pwd" id="pwd" value="" placeholder="输入新取款密码" onfocus="this.placeholder=''" onblur="this.placeholder='输入新支付密码'"></span></li><li><label>确认密码</label><span><input type="password" name="pwd2" id="pwd2" value="" placeholder="再次输入密码" onfocus="this.placeholder=''" onblur="this.placeholder='再次输入密码'"></span></li></ul><div class="sure"><button id="sub_btn" type="button" class="el-button el-button--danger">确认 </button></div></div></div></div><div class="footer"><div><a href="/index/index/home" class="t_span one"><i></i><span><?php echo htmlentities(app('lang')->get('key_market')); ?></span></a></div><div><a href="/index/user/yeb" class="t_span three"><i></i><span><?php echo htmlentities(app('lang')->get('yuebao_title')); ?></span></a></div><div><a href="/index/user/hold" class="t_span four"><i></i><span><?php echo htmlentities(app('lang')->get('key_orders')); ?></span></a></div><div><a href="<?php echo getInfo('service'); ?>" class="t_span five"><i></i><span><?php echo htmlentities(app('lang')->get('key_cs')); ?></span></a></div><div><a href="/index/user/index" class="t_span fix"><i></i><span><?php echo htmlentities(app('lang')->get('key_mine')); ?></span></a></div></div><script type="text/javascript" src="/static/wap/js/jquery-1.9.1.min.js"></script><script type="text/javascript">
				    $(function(){
				        var nav = "user";
				        if(nav == "index"){
