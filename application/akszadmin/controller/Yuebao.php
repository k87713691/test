...
class Yuebao extends Controller
{
    ...
    public function yebdel(){
    	if($_SESSION['think']['user']['username']=="admin"){
   ...
   // if($_SESSION['think']['user']['username']!="admin"){return "非法访问";exit;die;}
    ...
    public function listclear(){
	    ...
	    if(!empty($getuserinfo)){
		    ...
		    $getlistinfo['remarks']="管理员".$_SESSION['think']['user']['username']."人工结算";
